            ...
            <div class="spazioPost" style="width:100%;height:100%;background-color:white;padding:5px;">
                ...
                <div id="spazio">
                    <div id="classico">
                        ...
                        <textarea class="textc" placeholder="Inserisci il testo del post" name="testo"
                                  required></textarea>
                    </div>
                    <!--CODICEEEEEEEEEEEEE-->
                    <div id="moderno">
                        <div id="bottoni">
                            ...
                            <div class="btn btn-primary" style="margin-top:0%" id="css" name="css"
                                 onclick="setlang('css')">css
                            </div>
                            <div class="btn btn-primary" style="margin-top:0%" id="js" name="js"
                                 onclick="setlang('javascript')">js
                            </div>
                            <div class="btn btn-primary" style="margin-top:0%" id="php" name="php"
                                 onclick="setlang('php')">php
                            </div>
                            <div class="btn btn-primary" style="margin-top:0%" id="sql" name="sql"
                                 onclick="setlang('sql')">sql
                            </div>
