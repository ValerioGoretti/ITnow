    ...
    <?php
        ...
        ?>
                ...
                <div style="margin-left:70%; margin-bottom:1%">
                    <div id="tastoClassico" class="btn btn-primary" style="margin-top:0%;" >Testo  <i class="fas fa-align-justify"></i></div>
                    <div id="tastoModerno" class="btn btn-primary" style="margin-top:0%;">Codice  <i  class="fa fa-code" aria-hidden="true" ></i></div>
                    </div>
