...
<head>
    ...
    <body>
        ...
        <div class="row"  style="height:100%;background-color:#822433; ">
            ...
            <h2 id="titolo" class="font-weight-normal" style="margin-top:10px;margin-left:20px;color:black;">Cambia email</h3>
            <p id="sottotitolo" class="font-weight-light"style="margin-left:15px;color:black;padding:10px">Per favore compila i seguenti campi</p>
            <div class="col-md-6" style="margin:0 auto">
             <form id='form'>       

                    
                    <div class="form-group" style="margin-top:50px">
                        <input required  id="p1" name="np" minlength="6" type="email" class="form-control-registrazione" placeholder="Nuova email" value="" />
                    </div>
                    
                    <div class="form-group" >
                         <input id='cambia' style="padding: 10px;border-radius: 5px; margin-left:30px;margin-top:90px;" type="submit" class="btnRegister font-weight-light" value="Cambia Email" name="submit"/>
                    </div>                   
                </div>
            </form>
            </div>
