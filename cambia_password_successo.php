...
<head>
    ...
    <body>
        ...
        <div class="row"  style="height:100%;background-color:#822433; ">
            ...
            <h2 class="font-weight-normal" style="margin-top:10px;margin-left:20px;color:black;">Cambia password</h3>
            <p class="font-weight-light"style="margin-left:20px;color:black;padding:10px">Per favore compila i seguenti campi</p>
            <div class="col-md-6" style="margin:0 auto">
                    ...
                    <div class="form-group" >
                        <input style="padding: 10px;border-radius: 5px; margin-left:25px;" type="submit" class="btnRegister font-weight-normal" value="Cambia Password" name="submit"/>
                    </div>                   
                </div>
            </form>
            </div>
