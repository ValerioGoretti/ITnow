	  ...
	  <div class="panel-body" style="background-color:#822433">
	  	...
	  	<div class="row font-weight-light" >
	  		...
	  		<div class="col-md-4" style="padding-top:30px;">
				...
				<br/>
				<button class="btn btn-success upload-result" id="vai" style="background-color:#ffff;color:black;border:none;">Upload Image</button>
				<div  id="ok" style="margin-top:200px;margin-left:50px; color:white">
					<h5>Immagine caricata con successo!</h5>
					<div class="btn btn-xl btn-primary inserimento" id="chiudi" style="width:200px;border:none;background-color:#fff;color:#822433">Chiudi e torna indietro!</div>  
				</div>  
			</div>
