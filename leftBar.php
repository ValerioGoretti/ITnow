<div class="leftBar font-weight-light" id="leftbar">
    ...
    if ($_SESSION['ruolo'] == 'docente') {
        ...
        $query2 = "SELECT anno_didattico, anno_didattico.anno, corso, docente , nome, cognome
                          ...
                          where collaboratori.email='$email' and stato='In corso'";
    }
    ...
    while ($line = pg_fetch_array($result, null, PGSQL_ASSOC)) { ?>
        <a href="homeAnno.php?corso=<?php echo $line['id']; ?>">
            <div class="leftcard grow" id="leftcard" style="color:black;">
        ...
        if (pg_num_rows($result2) > 0) {
            ...
            while ($line2 = pg_fetch_array($result2, null, PGSQL_ASSOC)) { ?>
                <a href="homeAnno.php?corso=<?php echo $line2['anno_didattico']; ?>">
                    <div class="leftcard grow" style="color:black;">
