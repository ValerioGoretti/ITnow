        ...
        function caricaNotifiche() {
            ...
            $.ajax({
                ...
                success: function (msg) {
                    ...
                    if (msg.contatore != 0) {
                        $('#n').text(msg.contatore);
                        $('#n').show();
                        $('#dropdownMenuButton').addClass("blob");
                    } else {
                        $('#n').hide();
                        $('#dropdownMenuButton').removeClass("blob");
                    }
...
<div class="rightBar font-weight-light" style="width:180px;border-radius:8px;">
    ...
    <div class="dropdown  font-weight-light" id="clicca">
        ...
        <button class="btn btn-secondary2"
                style="border-radius:10px;background-color:white;border:none;outline:none;width:120px;margin-left:15%;margin-top:10px;margin-bottom:15%;"
                type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">

            <i class="fas fa-bell" id="clicca" style="font-size:60px;color:#822433;"></i>
            <div id="n"
                 style="width:30px;height:30px;border-radius:50%;background-color:#822433;font-size:15px;text-align:center;padding:3px;color:white;float:right;display:none">
                0
            </div>
        </button>
