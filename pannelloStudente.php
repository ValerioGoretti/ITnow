    ...
    if (!$ciSono) {
        ...
        foreach ($post as $p) {
            ...
            <div class="post">
                ...
                <div class="autore">
                    <h3><?php echo $p['nomeDoc'] . ' ' . $p['cognomeDoc'] . '<br>' . $p['corso'] . ' ' . $p['anno']; ?></h3>
                </div>
                <div class="linea">
                    <div class="line"></div>
                </div>
                <div class="testoPost t font-weight-light"><?php echo $p['testo']; ?> <br><br>
                    <?php $i = $p['idpost'];
                    if ($p['codice'] != null and $p['linguaggio'] != null) {
                        ?>
                        ...
                        <div id="textCode<?php echo $i ?>" class="animate slideIn">
                            <div style="background-color:#282a36; color:#fff; width:100px; text-align:center"
                                 id="ling<?php echo $i ?>"><?php echo $p['linguaggio']; ?></div>
                            <textarea name="editor" id="editor<?php echo $i ?>" style="resize: none"
                                      readonly> <?php echo $p['codice'] ?></textarea></div>
                    ...
                    while ($linefile = pg_fetch_array($result, null, PGSQL_ASSOC)) { ?>
                        <a href="<?php echo $linefile['url']; ?>" download="<?php echo $linefile['name']; ?>"
                           style="text-decoration:none">
                            <div class="attache "><?php echo $linefile['name']; ?> <i class="fas fa-paperclip"></i>
                            </div>
                        </a>
                        <?php
                    } ?>
