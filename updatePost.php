<?php
    function ottieniDati($matricola){
        ...
        while ($line  = pg_fetch_array($result,null,PGSQL_ASSOC)){
                $array[]=array('idCorso'=>$line['id'],'corso'=>$line["corso"],'anno'=>$line['anno'],'idpost'=>$line['idpost'],'titolo'=>$line['intestazione'],'testo'=>$line['testo'],'timestamp'=>$line['data'],'nomeDoc'=>$line["nome"],'cognomeDoc'=>$line["cognome"],'emailDoc'=>$line["email"], 'data' => $line['data'], 'codice'=> $line['codice'], 'linguaggio' => $line['linguaggio']);
            }
